            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                >
                    ...
                    <TypographyH2 className="font-serif text-4xl md:text-5xl font-bold tracking-tight border-none pb-0">
                        Projects that <span className="text-primary/60">define</span> my craft
                    </TypographyH2>
                </motion.div>
                        ...
                        >
                            <Link href={`/projects/${project.slug}`} className="block h-full">
                                ...
                                >
                                    ...
                                    {/* Gradient overlay for better text contrast at the bottom */}
                ...
                >
                    <Link
                        href="/projects"
                        className="group inline-flex items-center gap-2 text-lg font-medium hover:text-primary/80 transition-colors"
                    >
                        View All Projects
